                    ...
                    <div class="full col-sm-9">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                ...
                                <div class="well">
                                    <form class="form-horizontal" action="home" enctype="multipart/form-data" role="form">
                                        <h4>create a post</h4>
                                        ...
                                        <ul class="list-inline" style="position: relative">
                                            <li><a href="">
<%--                                                <i class="glyphicon glyphicon-upload" style="cursor: pointer"></i>--%>
                                                <input type="file"
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <p> Design, build, test, and prototype
                                            ...
                                            <a href="#" style="text-decoration: underline; color: #0db332;">read
                                                more...</a>
                                        </p>
                                    </div>
                                </div>
